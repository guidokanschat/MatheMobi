...
\begin{frame}{Komplexe Eigenwerte}
  ...
  \end{block}
  \pause
  Sei nun $r\pm i\phi$ ein solches Paar mit den Eigenvektoren $\vu\pm \ii\vv$
  \begin{align*}
    A (\vu\pm \ii\vv) &= (r+\ii\phi) (\vu\pm \ii\vv),\\
    e^A (\vu\pm \ii\vv) &= e^{r+i\phi} (\vu\pm \ii\vv) = e^r (\cos\phi \pm \ii \sin\phi)(\vu\pm \ii\vv).
  \end{align*}
\end{frame}
