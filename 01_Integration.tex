...
\begin{frame}{\glqq{}Hauptsatz\grqq{} der Differential- und Integralrechnung}
    ...
    \begin{columns}
        ...
        \begin{align*}
            F(x\!+\!h)\!-\!F(x) &= 
            \int_{\color{red}a}^{\color{blue}x+h} f(t)\,dt -\! {\color{red}\int_a^x} f(t)\,dt
...
Sei $f$ eine stetige Funktion und $F$ das unbestimmte Integral von $f$. Dann ist $F$ stetig differenzierbar und es gilt
    \begin{gather*}
