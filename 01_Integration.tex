...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\gkerror{Fehlt}
\mrwarning{Vorschlag für Abschlussfragen}
\begin{frame}{Abschlussfragen}
    \begin{enumerate}
...
\begin{frame}{Berechnung von Volumina}
    ...
    \end{enumerate}
\end{frame}
\mrnote{Abbildung für die Übungsaufgabe mit dem drehenden Quadrat}
\includegraphics[width=0.6\textwidth]{fig/drehendes_Quadrat.tikz}
